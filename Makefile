# This Makefile is for the Runners::Journal extension to perl.
#
...
#     AUTHOR => q[Logan Bell <logan@orchardtech.com>]
#     BUILD_REQUIRES => { ExtUtils::MakeMaker=>q[6.42] }
#     DIR => []
#     DISTNAME => q[Runners-Journal]
#     MIN_PERL_VERSION => q[5.008008]
#     NAME => q[Runners::Journal]
#     NO_META => q[1]
#     PL_FILES => {  }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Runners/Journal.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Runners
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Runners
...
TO_INST_PM = lib/Runners/Journal.pm \
	lib/Runners/Run.pm

PM_TO_BLIB = lib/Runners/Journal.pm \
	blib/lib/Runners/Journal.pm \
	lib/Runners/Run.pm \
	blib/lib/Runners/Run.pm
...
DISTNAME = Runners-Journal
DISTVNAME = Runners-Journal-0.01
...
manifypods : pure_all  \
	lib/Runners/Journal.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Runners/Journal.pm $(INST_MAN3DIR)/Runners::Journal.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Logan Bell &lt;logan@orchardtech.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Runners/Journal.pm blib/lib/Runners/Journal.pm \
	  lib/Runners/Run.pm blib/lib/Runners/Run.pm 
